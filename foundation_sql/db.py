...
class Database:
    ...
    def run_sql(self, sql_template: str, **context) -> Any:
        ...
        try:
            query, params = j2sql.from_string(sql_template, context=context)
            ...
            with conn.begin():
                try:
                    ...
                    statements = [
                        ...
                        # Ignore empty statements and comments (POSTGRESQL DOESNT IGNORE THEM LIKE MYSQL/SQLITE AND THROWS ERROR OTHERWISE)
